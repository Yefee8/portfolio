            ...
            projects.map((project, index) => {
              return (
                <div key={index} className={`w-1/3 flex justify-center ${!!(index & 1) && "mt-64"}`}>
                  <div className="w-96 h-[375px] rounded-3xl border-black duration-500 group cursor-pointer hover:border-primary p-4 border items-center flex flex-col gap-4"
                    data-aos="fade-up">
