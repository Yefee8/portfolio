        ...
        {projects.map((project, index) => {
          return (
            ...
            >
              ...
              >
                <div
                  className="sm:w-96 w-3/4 rounded-3xl border-purple-500/50 duration-500 group cursor-pointer hover:border-purple-500 !p-4 border-[2.5px] items-center flex flex-col gap-4"
                    ...
                    <div className="flex-wrap gap-1 flex mt-4 items-center justify-start">
                      {project.tags.map((tag) => {
                        return (
                          <span
                            key={index}
                            className="px-2 text-white py-1 font-medium sm:text-sm text-[10px] relative bg-[rgba(255,145,48,1)] duration-200 rounded-full"
                          >
                            {tag}
                          </span>
                        );
