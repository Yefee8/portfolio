        ...
        {repos.map((repo, index) => {
          return (
            ...
            >
              ...
              >
                <div
                  className="sm:w-96 w-3/4 rounded-3xl border-transparent shadow-xl duration-500 group cursor-pointer hover:border-primary !p-4 border-[2.5px] items-center flex flex-col gap-4"
                  data-aos={!!(index & 1) ? "fade-right" : "fade-left"}
                >
                  {typeof repo.image !== "string" ? (
                    <Image
                      src={repo.image}
                      alt={repo.title + " ~ Yefee, Yavuz Efe"}
